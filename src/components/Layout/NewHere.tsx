...
const NewHere = styled(({ className }) => {
  ...
  return (
    <div className={className}>
      ...
      <div>
        <Button onClick={showMessage} label="" size="4" active >JOIN US TODAY</Button>
        <Text color="primary" size="3" weight="bold">hope to see you in church</Text>
      </div>

      {show && <div className="new-comers-message-wrap">
        <Text className="new-comers-message" size="4" color="white">The mission house Welcomes you.</Text> <br />
        <Text as="a" href="locateUs" className="locate-church" size="4" color="primary">LOCATE CHURCH</Text>
      </div>}
